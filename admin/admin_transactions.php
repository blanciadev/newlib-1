                ...
                <div class="topBorrowers-con">  
                    <?php
                        ...
                        if ($topBorrowerResult && mysqli_num_rows($topBorrowerResult) > 0) {
                            echo "<ol class='list-group' style='width:98%'>";
                            while ($topBorrowerData = mysqli_fetch_assoc($topBorrowerResult)) {
                                ...
                                echo "<li class='list-group-item d-flex flex-column justify-content-between align-items-start' style='height:45px; width:100%'>";
                                echo "<div class='w-100 d-flex flex-row justify-content-between' style='height: 20px;'>";
                                echo "<p style='font-size:12pt' class='fw-bold'>$name $lname</p>";
                    ...
                    <div class="stats">
            <h3 class="text-center my-4">Borrow / Return</h3>
            <div class="stats-con d-flex justify-content-center">
                <div class="buttons d-flex gap-3">
                    <a href="admin_book_borrow_dash.php" class="btn btn-lg btn-primary d-flex align-items-center justify-content-center" style="min-width: 150px;">
                        <i class="bi bi-book-half me-2"></i> Borrow Book
                    </a>
                    <a href="admin_return_dash.php" class="btn btn-lg btn-primary d-flex align-items-center justify-content-center" style="min-width: 150px;">
