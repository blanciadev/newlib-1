...
<body>
    ...
    if (mysqli_num_rows($result) > 0) {
        // Output each row as an accordion item
        while ($row = mysqli_fetch_assoc($result)) {
            ?>
            <div class="accordion-item">
                <h2 class="accordion-header" id="heading<?php echo $row['Contributor_ID']; ?>">
                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapse<?php echo $row['Contributor_ID']; ?>" aria-expanded="true" aria-controls="collapse<?php echo $row['Contributor_ID']; ?>">
                        <?php echo $row['Name']; ?>
                    </button>
                </h2>
                <div id="collapse<?php echo $row['Contributor_ID']; ?>" class="accordion-collapse collapse" aria-labelledby="heading<?php echo $row['Contributor_ID']; ?>" data-bs-parent="#accordionExample">
                    <div class="accordion-body">
                        <!-- Display book details -->
                        <p>Book Title: <?php echo $row['Book_Title']; ?></p>
